...
@dataclass
class RectHazards(Geom):  # pylint: disable=too-many-instance-attributes
    """Hazardous areas."""

    name: str = 'rect_hazards'
    num: int = 0  # Number of hazards in an environment
    size: list = field(default_factory=lambda: [0.2, 0.3])
